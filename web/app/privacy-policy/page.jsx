...
export const metadata = {
  title: "Privacy Policy | Chattiq",
  description: "Privacy policy and app details for Chattiq.",
};

const APP_DOMAIN = "chatiq.co.in";
const CONTACT_EMAIL = process.env.NEXT_PUBLIC_CONTACT_EMAIL || "support@chatiq.co.in";
const APP_ICON = "/chatops-icon.png";
const CATEGORY = "AI Agent Platform";
    ...
    <div>
      ...
      <main style={{ maxWidth: 960, margin: "0 auto", padding: "40px 20px 64px" }}>
        ...
        <section style={{ color: "#444", lineHeight: 1.65 }}>
          ...
          <p>
            We use chat messages and uploaded content only to provide AI agent features, WhatsApp
            integrations, and account support. We do not sell personal data. Access to operational
