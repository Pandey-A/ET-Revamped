  ...
  return (
    <>
      ...
      {!isOpen && (
        ...
        >
          <img src="/favicons/favicon.svg" alt="ElevateTrust AI" style={{ width: '36px', height: '36px', backgroundColor: 'white', borderRadius: '50%', padding: '4px' }} />
          {unreadCount > 0 && (
        ...
        <div className="et-float-panel" role="dialog" aria-label="Chat with AI Assistant">
          ...
          <div className="et-float-header">
            <div className="et-float-header-info">
              ...
              <div>
                <div className="et-float-header-title">ElevateTrust AI</div>
            ...
            {messages.length === 0 && (
              <div className="et-float-welcome">
                ...
                <p className="et-float-welcome-sub">
                  Ask me anything about our deepfake detection platform, video verification, or how ElevateTrust can help you.
                </p>
                <div className="et-float-suggestions">
                  <button 
                    className="et-float-suggestion-chip" 
                    onClick={() => { setInput("How do I scan a video for deepfakes?"); setTimeout(sendMessage, 50); }}
                  >
                  ...
                  <button 
                    className="et-float-suggestion-chip" 
                    onClick={() => { setInput("What kind of deepfakes do you detect?"); setTimeout(sendMessage, 50); }}
                  >
                    What do you detect?
                  </button>
                </div>
          ...
          <div className="et-float-footer">
            Powered by <strong>ElevateTrust</strong>
          </div>
        </div>
      )}
    </>
